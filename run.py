...
def get_sales_data():
    ...
    Run a while loop to collect a valid string of data from use via terminal. 
    Must be a string of 7 numbers seperated by commas.
     The loop repeats until data provided is valid.
    """
    while(True):
        print("please enter sales data from the laster market.")
...
def get_last_5_entries_sales():
    """
    Collects collumn of data from sales worksheet,
